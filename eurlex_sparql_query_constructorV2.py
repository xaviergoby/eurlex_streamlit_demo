...
class EURLexSPARQLQueryConstructor:
	...
	def update_query_settings(self, distinct, limit, order_by, earliest_pub_date, subjects, indent_depth):
		self.__distinct = distinct
		self.__limit = limit
		self.__order_by = order_by
		###
...
if __name__ == "__main__":
	...
	res_limit_opt = 15
	order_by_opt = "desc"
	earliest_pub_date_opt = "2018-01-01"
	# subjects_opt = None
	...
	query = eurlex_sparql_query_builder.query_str
